...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        #### Setting self.activation_function to my implemented sigmoid function ####
        #
        # Note: in Python, we can define a function with a lambda expression, as shown below.
